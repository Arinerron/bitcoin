...
# TestNode: A peer we use to send messages to jobecoind, and store responses.
...
class CompactBlocksTest(JobecoinTestFramework):
    ...
    # This test actually causes jobecoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that jobecoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for jobecoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # jobecoind will not send blocktxn responses for blocks whose height is

#!/usr/bin/env python3
# Copyright (c) 2014-2017 The Jobecoin Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test mempool persistence.

By default, jobecoind will dump mempool on shutdown and
...
class MempoolPersistTest(JobecoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give jobecoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent jobecoind from writing mempool.dat to disk. Verify that `savemempool` fails")

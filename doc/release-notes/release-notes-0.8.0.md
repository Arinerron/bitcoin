Jobecoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/jobecoin/files/Jobecoin/jobecoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Jobecoin
...
New/changed settings (command-line or jobecoin.conf file)
--------------------------------------------------------

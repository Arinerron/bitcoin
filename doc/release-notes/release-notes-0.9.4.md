Jobecoin Core version 0.9.4 is now available from:

  https://jobecoin.org/bin/0.9.4/
...
this update is incompatible with the Jobecoin system and could lead to consensus
forks.

Jobecoin Core released binaries from https://jobecoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~jobecoin/+archive/ubuntu/jobecoin
- A third-party or self-compiled Jobecoin Core

upgrade to Jobecoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

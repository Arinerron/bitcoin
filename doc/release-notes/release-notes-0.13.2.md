Jobecoin Core version 0.13.2 is now available from:

  <https://jobecoin.org/bin/jobecoin-core-0.13.2/>
...
- #8908 `4a974b2` Update jobecoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow jobecoin-tx to create v2 transactions (btcdrak)

Jobecoin Core version 0.10.4 is now available from:

  <https://jobecoin.org/bin/jobecoin-core-0.10.4/>
...
- #6953 `43c2789` Split jobecoin-tx into its own package
- #6953 `dfe0d4d` Include jobecoin-tx binary on Debian/Ubuntu

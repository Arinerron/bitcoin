Jobecoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/jobecoin/files/Jobecoin/jobecoin-0.5.4/
...
http://gitorious.org/jobecoin/jobecoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Jobecoin-Qt notifications under Growl 1.3.
Increase required age of Jobecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxJobecoin properly when installing Jobecoin-Qt over it. (Windows)

...
This document provides guidelines for internationalization of the Jobecoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `jobecoin_en.ts` remains unchanged.

...
Jobecoin Core version *version* is now available from:

  <https://jobecoin.org/bin/jobecoin-core-*version*/>
...
GCC 4.8.x
--------------
The minimum version of GCC required to compile Jobecoin Core is now 4.8. No effort will be

...
#ifndef JOBECOIN_WALLET_WALLET_H
#define JOBECOIN_WALLET_WALLET_H
...
public:
     ...
     * on this jobecoin node, and set to 0 for transactions that were created
...
#endif // JOBECOIN_WALLET_WALLET_H

...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<JobecoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_jobecoin-qt -platform xcb      # Linux
//     src/qt/test/test_jobecoin-qt -platform windows  # Windows
//     src/qt/test/test_jobecoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = JobecoinUnits::formatWithUnit(unit, balance, false, JobecoinUnits::separatorAlways);
    ...
    // Amount input
    JobecoinAmountField* amountInput = receiveCoinsDialog.findChild<JobecoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: jobecoin:")) != -1);

...
#ifndef JOBECOIN_QT_JOBECOINUNITS_H
#define JOBECOIN_QT_JOBECOINUNITS_H
...
/** Jobecoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class JobecoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit JobecoinUnits(QObject *parent);

    /** Jobecoin units.
      @note Source: https://en.jobecoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef JobecoinUnits::Unit JobecoinUnit;

#endif // JOBECOIN_QT_JOBECOINUNITS_H

...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.jobecoin.sipa.be", true); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me", true); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.jobecoin.dashjr.org", false); // Luke Dashjr
        vSeeds.emplace_back("seed.jobecoinstats.com", true); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.jobecoin.jonasschnelli.ch", true); // Jonas Schnelli, only supports x1, x5, x9, and xd
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.jobecoin.jonasschnelli.ch", true);

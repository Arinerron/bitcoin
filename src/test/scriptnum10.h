...
#ifndef JOBECOIN_TEST_SCRIPTNUM10_H
#define JOBECOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Jobecoin Core 0.10.0, for cross-comparison.
 */
public:
